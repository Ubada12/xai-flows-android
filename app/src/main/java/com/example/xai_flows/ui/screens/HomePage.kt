...
import com.example.xai_flows.ui.components.common.FooterMobile
import com.example.xai_flows.ui.components.home.*
...
fun HomePage(
    ...
    Column(
        ...
        Column(
            ...
            LoopingVideoPlayer(
                videoResId = com.example.xai_flows.R.raw.landing,  // Place your video in res/raw folder
                modifier = Modifier
                    .fillMaxWidth()
                    .height(200.dp)
            )
        ...
        Column(
            ...
            VisionSection(
                title = "Our Vision",
                description = stringResource(com.example.xai_flows.R.string.vision)
            )
            Spacer(modifier = Modifier.height(24.dp))
        }
